    ...
    <div className="flex flex-col gap-20">
      <article>
        <div className="flex animate-in flex-col gap-3">
          ...
          <h1 className="text-justify text-3xl font-bold leading-tight tracking-tight text-primary">
            {post.title}
          </h1>
          <p
            className="animate-in text-justify text-lg leading-tight text-secondary md:text-xl"
        ...
        <div className="h-12" />
        <div
          className="project prose animate-in text-justify"
